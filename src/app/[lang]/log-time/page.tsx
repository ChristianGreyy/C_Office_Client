...
import { RootState, createEmployeeAttendanceAction, useAppDispatch } from "@/redux";
...
export default function LogTime() {
  ...
  const solveUpdateEmployeeAttendance = async () => {
    ...
    try {
      const response = await dispatch(createEmployeeAttendanceAction(data)).unwrap()
          ...
          <div className="flex basis-3/5 flex-col items-center p-8 bg-white">
            ...
            <div className="log-time-button mt-10 flex justify-between">
              <div className="check-in-button">
                <Button onClick={() => solveUpdateEmployeeAttendance()} className="bg-orange-600 mr-8 border-0 text-white !font-bold hover:bg-orange-700 py-2 px-4 rounded">
                  Check in
                </Button>
                <button
              ...
              <div className="check-out-button">
                <Button onClick={solveUpdateEmployeeAttendance} className="bg-orange-600 border-0 text-white !font-bold hover:bg-orange-700 py-2 px-4 rounded">
                  Check out
                </Button>
                {/* <button>07:59</button> */}
              </div>
